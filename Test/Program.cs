...
using static NewLife.Caching.Redis;
...
namespace Test
{
    internal class Program
    {
        ...
        {
            var ic = Create("127.0.0.1:6379", 3);
        ...
        {
            var rds = Create("127.0.0.1:6001", 0);
            rds.Log = XTrace.Log;
            //rds.Init(null);
